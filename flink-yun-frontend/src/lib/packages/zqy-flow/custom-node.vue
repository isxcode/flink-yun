            ...
            <el-dropdown v-if="showMenu" trigger="click" @command="handleCommand">
                ...
                <template #dropdown>
                    <el-dropdown-menu>
                        ...
                        <el-dropdown-item v-if="status === 'SUCCESS' && ['FLINK_SQL','QUERY_JDBC', 'SPARK_JAR','SPARK_CONTAINER_SQL','PRQL'].includes(node.data.nodeConfigData.workType)" command="node_result">运行结果</el-dropdown-item>
