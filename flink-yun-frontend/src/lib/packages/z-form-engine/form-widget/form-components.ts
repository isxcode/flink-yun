...
import FormInputPhoneConfig from './component-config/form-input-phone.config'
import FormInputEmailConfig from './component-config/form-input-email.config'
