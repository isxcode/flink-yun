<template>
  <div class="footer">
    ...
    <div class="content">
      <div class="left">
        <img class="logo-img" src="https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiliuyun/website/web-img/logo.jpg" alt=""/>
        <div class="logo-name">
          {{ $t("company_name") }}
        </div>
        <img class="wechat-img" src="https://isxcode.oss-cn-shanghai.aliyuncs.com/zhiliuyun/website/web-img/qrcode.jpg" alt=""/>
