...
```json
{
  "spark.kubernetes.driver.podTemplateFile":"/home/zhiliuyun/pod-init.yaml",
  "spark.kubernetes.executor.podTemplateFile":"/home/zhiliuyun/pod-init.yaml"
}
```
...
```text
这是因为spark的standalone集群版本，和flink-yun中spark-min中自带的版本冲突，需要将两边的版本保持一致
```

```bash
cp -r /opt/spark/* /home/ispong/flink-yun/spark-min/
rm /home/ispong/flink-yun/spark-min/conf/spark-env.sh
rm /home/ispong/flink-yun/spark-min/conf/spark-defaults.conf
```
