        ...
        <div class="module-feat-left">
            <div class="content">
                ...
                <div class="right">
                    ...
                    <div class="line-2">支持大量计算引擎平台，如Kubernetes、Flink Cluster、Yarn、CDH。可无缝迁移，无缝切换，帮助企业更优管理集群资源。</div>
        ...
        <div class="module-feat-left">
            <div class="content">
                ...
                <div class="right">
                    ...
                    <div class="line-2">超多作业类型，包括数据同步、Bash、Python、FlinkSql、Jdbc、自定义Jar等。提供客户二次开发模版，任何复杂的场景都可以通过写代码的方式解决。</div>
                    <div class="line-3" @click="handleQuickClick">立即体验</div>
                </div>
            </div>
        </div>
