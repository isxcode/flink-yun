package com.isxcode.acorn.modules.monitor.service;
...
import com.isxcode.acorn.api.api.constants.ApiStatus;
...
import com.isxcode.acorn.modules.monitor.mapper.MonitorMapper;
import com.isxcode.acorn.modules.monitor.repository.MonitorRepository;
...
import com.isxcode.acorn.api.monitor.constants.TimeType;
...
public class MonitorBizService {
	...
	public GetClusterMonitorRes getClusterMonitor(GetClusterMonitorReq getClusterMonitorReq) {
		...
		// 查询记录数
		List<MonitorLineAo> monitorLine = monitorRepository.queryMonitorLine(getClusterMonitorReq.getClusterId(),
