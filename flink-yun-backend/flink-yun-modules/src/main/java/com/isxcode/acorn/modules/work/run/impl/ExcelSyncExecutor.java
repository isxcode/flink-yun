...
//            .mainClass("com.isxcode.acorn.plugin.excelSync.jdbc.Execute").appResource("flink-excel-sync-jdbc-plugin.jar")
...
//                + "zhiliuyun-agent" + File.separator + "file" + File.separator + csvFileName);
//            // 删除本地的csv文件
//            FileUtil.del(csvFilePath);
//            pluginReq.setCsvFilePath(engineNode.getAgentHomePath() + File.separator + "zhiliuyun-agent"
...
//            pluginReq.getFlinkConfig().put("hive.metastore.uris", targetDatasource.getMetastoreUris());
//        }
//
//        // 开始构造executeReq
