...
public interface ClusterNodeRepository extends JpaRepository<ClusterNodeEntity, String> {
    ...
    @Query("SELECT E FROM ClusterNodeEntity E" + " WHERE E.clusterId = :engineId  " + "and ( E.name LIKE %:keyword% " + "OR E.remark LIKE %:keyword% " + "OR E.host LIKE %:keyword%) order by E.createDateTime desc ")
