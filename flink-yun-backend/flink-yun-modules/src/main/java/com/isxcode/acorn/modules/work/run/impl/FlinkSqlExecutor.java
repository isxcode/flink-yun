...
//        return WorkType.EXECUTE_FLINK_SQL;
//    }
//
//    @Override
...
//
//        // 开始构造flinkSubmit
//        SubmitWorkReq submitJobReq = SubmitWorkReq.builder().entryClass("com.isxcode.acorn.plugin.sql.execute.Job")
...
//            .acornPluginReq(PluginReq.builder().flinkSql(workRunContext.getScript()).build())
