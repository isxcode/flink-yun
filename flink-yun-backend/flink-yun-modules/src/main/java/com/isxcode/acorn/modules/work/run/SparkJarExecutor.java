...
public class SparkJarExecutor extends WorkExecutor {
    ...
    protected void execute(WorkRunContext workRunContext, WorkInstanceEntity workInstance) {
        ...
        // SparkSubmit.builder().verbose(true).mainClass(jarJobConfig.getMainClass())
        ...
        // executeReq.setAgentHomePath(engineNode.getAgentHomePath() + File.separator +
        ...
        // paramsMap2.put("sparkHomePath", engineNode.getFlinkHomePath());
        // baseResponse = HttpUtils.doGet(
        ...
        // paramsMap3.put("sparkHomePath", engineNode.getFlinkHomePath());
        // baseResponse = HttpUtils.doGet(
