package com.isxcode.acorn.modules.datasource.source;
...
import com.isxcode.acorn.modules.datasource.service.DriverShim;
    ...
    public Connection getConnection(ConnectInfo connectInfo) throws IsxAppException {
        ...
        if (driver == null) {
            ...
            if (isxAppProperties.isDockerMode()) {
                driverPath = "/var/lib/zhiliuyun-system/" + driverEntity.getFileName();
            }
