...
// import com.isxcode.acorn.agent.properties.SparkYunAgentProperties;
// import com.isxcode.acorn.api.agent.pojos.req.DeployContainerReq;
...
// .setAppResource(yagExecuteWorkReq.getAgentHomePath() + File.separator +
// "file" + File.separator
// + yagExecuteWorkReq.getSparkSubmit().getAppResource())
// .setSparkHome(yagExecuteWorkReq.getAgentHomePath() + File.separator +
// "spark-min");
// } else {
// sparkLauncher = new SparkLauncher().setVerbose(false)
// .setMainClass(yagExecuteWorkReq.getSparkSubmit().getMainClass()).setDeployMode("cluster")
...
// File[] jarFiles = new File(yagExecuteWorkReq.getAgentHomePath() +
// File.separator + "lib").listFiles();
// if (jarFiles != null) {
...
// String libPath = yagExecuteWorkReq.getAgentHomePath() + File.separator +
// "file" + File.separator + e
// + ".jar";
...
// .setAppResource(deployContainerReq.getAgentHomePath() + File.separator +
// "plugins" + File.separator
// + deployContainerReq.getSparkSubmit().getAppResource())
// .setSparkHome(deployContainerReq.getAgentHomePath() + File.separator +
// "spark-min");
//
// if (!Strings.isEmpty(deployContainerReq.getAgentHomePath())) {
// File[] jarFiles = new File(deployContainerReq.getAgentHomePath() +
// File.separator + "lib").listFiles();
// if (jarFiles != null) {
// for (File jar : jarFiles) {
// try {
...
//
// long timeoutExpiredMs = System.currentTimeMillis() +
// sparkYunAgentProperties.getSubmitTimeout() * 1000;
//
...
//
// @Override
// public String getAppStatus(String appId, String sparkHomePath) throws
// IOException {
//
// String getStatusCmdFormat = "yarn application -status %s";
//
// Process process = Runtime.getRuntime().exec(String.format(getStatusCmdFormat,
// appId));
//
...
//
// @Override
// public String getStdoutLog(String appId, String sparkHomePath) throws
// IOException {
//
// String getLogCmdFormat = "yarn logs -applicationId %s";
// Process process = Runtime.getRuntime().exec(String.format(getLogCmdFormat,
// appId));
//
// InputStream inputStream = process.getInputStream();
// BufferedReader reader = new BufferedReader(new InputStreamReader(inputStream,
...
// throw new IsxAppException(errLog.toString());
// } else {
// Pattern regex = Pattern.compile("LogType:stdout-start\\s*([\\s\\S]*?)\\s*End
// of LogType:stdout");
...
//
// @Override
// public String getAppLog(String appId, String sparkHomePath) throws
// IOException {
//
// String getLogCmdFormat = "yarn logs -applicationId %s";
// Process process = Runtime.getRuntime().exec(String.format(getLogCmdFormat,
...
// throw new IsxAppException(errLog.toString());
// } else {
// Pattern regex = Pattern.compile("LogType:stderr\\s*([\\s\\S]*?)\\s*End of
// LogType:stderr");
// Matcher matcher = regex.matcher(errLog);
// String log = "";
// while (matcher.find()) {
...
//
// @Override
// public String getAppData(String appId, String sparkHomePath) throws
// IOException {
//
// String getLogCmdFormat = "yarn logs -applicationId %s";
//
...
// throw new IsxAppException(errLog.toString());
// } else {
// Pattern regex = Pattern.compile("LogType:spark-yun\\s*([\\s\\S]*?)\\s*End of
// LogType:spark-yun");
// Matcher matcher = regex.matcher(errLog);
// String log = "";
...
// Process process = Runtime.getRuntime().exec(String.format(killAppCmdFormat,
// appId));
//
// InputStream inputStream = process.getInputStream();
// BufferedReader reader = new BufferedReader(new InputStreamReader(inputStream,
