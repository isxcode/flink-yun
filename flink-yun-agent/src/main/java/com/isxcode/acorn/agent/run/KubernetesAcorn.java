...
// // k8s命令会返回特殊字符
// return ("k8s://" + errLog.substring(startIndex, endIndex)).replaceAll("0m",
// "").replaceAll("\u001B", "")
// .replaceAll("\\[", "");
// }
...
// sparkLauncher.addJar("local:///opt/spark/examples/jars/lib/" +
// jarFiles[i].getName());
// sparkLauncher.setConf("spark.kubernetes.driver.volumes.hostPath." + i +
// ".mount.path",
...
// ".options.path",
// jarFiles[i].getPath());
// sparkLauncher.setConf("spark.kubernetes.executor.volumes.hostPath." + i +
// ".mount.path",
// "/opt/spark/examples/jars/lib/" + jarFiles[i].getName());
// sparkLauncher.setConf("spark.kubernetes.executor.volumes.hostPath." + i +
// ".mount.readOnly",
...
//
// sparkLauncher.setConf("spark.kubernetes.container.image",
// "apache/spark:v3.1.3");
...
// yagExecuteWorkReq.getSparkSubmit().getAppResource());
// sparkLauncher.setConf("spark.kubernetes.driver.volumes.hostPath.jar.mount.readOnly",
// "false");
// sparkLauncher.setConf("spark.kubernetes.driver.volumes.hostPath.jar.options.path",
// yagExecuteWorkReq.getAgentHomePath() + File.separator + "plugins" +
// File.separator
// + yagExecuteWorkReq.getSparkSubmit().getAppResource());
// sparkLauncher.setConf("spark.kubernetes.executor.volumes.hostPath.jar.mount.path",
// "/opt/spark/examples/jars/" +
// yagExecuteWorkReq.getSparkSubmit().getAppResource());
// sparkLauncher.setConf("spark.kubernetes.executor.volumes.hostPath.jar.mount.readOnly",
// "false");
...
//
// @Override
// public String getAppStatus(String podName, String sparkHomePath) throws
// IOException {
//
...
// InputStreamReader(errStream, StandardCharsets.UTF_8));
// StringBuilder errLog = new StringBuilder();
// String line;
// while ((line = reader.readLine()) != null) {
// errLog.append(line).append("\n");
